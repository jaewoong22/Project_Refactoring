...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	...
	<c:forEach var="purchase" items="${list}">
		...
		<tr class="ct_list_pop">
			...
			<td></td>
			<td align="center"><a href="/purchase/getPurchase?tranNo=${purchase.tranNo }">${product.prodName} 상세보기</a></td>		
			<td></td>
			...
			<c:if test="${purchase.tranCode.equals('001')}">
				<td align="center"><a href="/purchase/cancelOrder?tranNo=${purchase.tranNo }&tranCode=${purchase.tranCode}">구매취소</a></td>
			</c:if>
