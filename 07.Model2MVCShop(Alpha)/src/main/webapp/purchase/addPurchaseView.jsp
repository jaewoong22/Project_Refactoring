...
function fncAddPurchase() {
	var num = document.addPurchase.buyNum.value;
	var stock = document.addPurchase.stock.value;
	console.log(num);
	
	if(num == null || num>stock){
		alert("구매 가능 개수를 초과했습니다.");
		return;
	}
...
<input type="hidden" name="stock" value="${product.prodStock  }"/>
